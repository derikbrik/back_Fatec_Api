...
import br.com.sanjavalley.heyalexia.message.ResponseMessage;
import br.com.sanjavalley.heyalexia.service.CSVService;
...
public class CSVController {
	...
	public ResponseEntity<List<Cliente>> getAllClientes() {
		try {
			List<Cliente> clientes = fileService.getAllClientes();
			if (clientes.isEmpty()) {
